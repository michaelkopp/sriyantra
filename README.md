...
condition can be built into a construction of this kind — the question reduces
to a finite sequencing problem, and a clause-learning solver returns
unsatisfiable for both rings. These figures can be *selected* from the family
but not *constructed*.
